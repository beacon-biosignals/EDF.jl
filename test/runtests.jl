...
@testset "Just Do It" begin
    ...
    @test_throws ArgumentError EDF.edf_header_string("", -1011.0543) == "-1011.05"
    @test_throws ArgumentError EDF.edf_header_string("", -1013441.5) == "-1013442"
    @test_throws ArgumentError EDF.edf_header_string("", -1013441.3) == "-1013441"
